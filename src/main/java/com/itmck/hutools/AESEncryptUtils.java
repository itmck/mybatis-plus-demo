...
public class AESEncryptUtils {
    ...
    public static void main(String[] args) {
        String str = AESEncryptUtils.encrypt("321321390--.p['a>d.zsd[a.?DASdas890-s9d-0qdmas.mxczlcjzlxcnzlxkcnxzkjchajksdnjklnczxkoch9-ajadn;klmczxl;cnzxiophz觉得我气魄低级趣味的节温器豆皮弯曲度亲我赌气我武器", "hungybsgatqweryx");
        System.out.println(str);
        String decrypt = AESEncryptUtils.decrypt(str, "hungybsgatqweryx");
